import 'package:delivery_w_flutter/src/pages/client/profile/info/client_profile_info_controller.dart';
  ...
  Widget _textName(){
    return Container(
      ...
      child: ListTile(
        ...
        title: Text('${con.user.value.name ?? ''} ${con.user.value.lastnmae ?? ''}'),
